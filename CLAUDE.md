...
- Single output `HDMI-A-1` 1920×1080@144, scale 1. Webcam = Logitech C615 `/dev/video0` (720p/1080p). Default mic = the C615's mono capture, **sitting at 53 % gain** — the "too quiet" complaint starts there; `rec` should raise it (PipeWire allows >100 %) and render applies `loudnorm`.
